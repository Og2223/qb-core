...
QBShared.Vehicles = {
    --- Compacts
    ['19ramoffroad'] = { -- This has to match the spawn code of the vehicle
        ['name'] = '19ramoffroad', -- This is the display of the vehicle
        ['brand'] = 'Dodge', -- This is the vehicle's brand (Ford, Chevrolet, BMW, Mercedes, etc)
        ['model'] = '19ramoffroad', -- This must match the spawn code of the vehicle
        ...
        ['hash'] = `19ramoffroa`, -- This has to match the spawn code of the vehicle and must be surrounded by backticks. Example of a Backtick: `
